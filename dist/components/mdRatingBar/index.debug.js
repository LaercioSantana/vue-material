...
exports.default = {
  ...
  watch: {
    mdFrontIcon: function mdFrontIcon() {
      this.srcFrontIcon = this.checkSrc(this.mdFrontIcon);
    },
    mdBackIcon: function mdBackIcon() {
      this.srcBackIcon = this.checkSrc(this.mdBackIcon);
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.srcBackIcon) ? _c('div', {
    staticClass: "md-back-stars"
  }, _vm._l((_vm.mdNumStars), (function(i) {
    return (_vm.srcBackIcon) ? _c('md-icon', {
      class: [_vm.iconClasses],
      attrs: {
        "md-src": _vm.srcBackIcon
      },
      nativeOn: {
    ...
    return _c('md-icon', {
      class: [_vm.iconClasses],
      attrs: {
        "md-iconset": _vm.mdBackIconset
      },
      domProps: {
        "innerHTML": _vm._s(_vm.backIcon)
      },
      nativeOn: {
        "mouseover": function($event) {
          _vm.hoverStars($event)
  ...
  }))), _vm._v(" "), (_vm.srcFrontIcon) ? _c('div', {
    staticClass: "md-front-stars",
    style: (_vm.frontStarsStyle)
  }, _vm._l((_vm.mdNumStars), (function(i) {
    return (_vm.srcFrontIcon) ? _c('md-icon', {
      class: [_vm.iconClasses],
      attrs: {
        "md-src": _vm.srcFrontIcon
      },
      nativeOn: {
        "mouseover": function($event) {
          _vm.hoverStars($event)
    ...
    return _c('md-icon', {
      class: [_vm.iconClasses],
      attrs: {
        "md-iconset": _vm.mdFrontIconset
      },
      domProps: {
        "innerHTML": _vm._s(_vm.frontIcon)
      },
      nativeOn: {
        "mouseover": function($event) {
          _vm.hoverStars($event)
